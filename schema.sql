...
CREATE TABLE RECOMMENDATION_CANDIDATE (
    ...
    CONSTRAINT fk_recommendation_candidate_user
        FOREIGN KEY (user_id) REFERENCES USER(user_id)
        ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE RECOMMENDATION_SESSION (
    ...
    query_version VARCHAR(50) NULL,
    retrieval_topk INT NULL,
    rerank_topn INT NULL,
    routine_topn INT NULL,
    rerank_applied BOOLEAN NOT NULL DEFAULT FALSE,
    rerank_changed BOOLEAN NOT NULL DEFAULT FALSE,
    rerank_summary TEXT NULL,
    price_filter_json TEXT NULL,
...
CREATE TABLE RECOMMENDATION_ROUTINE (
    ...
    routine_themes VARCHAR(100) NULL,
    routine_pros TEXT NULL,
    routine_cons TEXT NULL,
