...
| 메인 페이지                         | 피부 분석                             |
| ------------------------------ | --------------------------------- |
| ![](docs/images/mainpage1.png) | ![](docs/images/photo_input1.png) |

| 피부 리포트                            | 루틴 리포트                               |
| --------------------------------- | ------------------------------------ |
| ![](docs/images/skin_report2.png) | ![](docs/images/routine_report1.png) |

| 제품 탐색                               | 내 화장대                           |
| ----------------------------------- | ------------------------------- |
| ![](docs/images/product_search.png) | ![](docs/images/my_vanity1.png) |
